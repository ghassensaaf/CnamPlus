                                                ...
                                                <div class="container-fluid">
                                                    <div class="row mb-1">
                                                        <div class="form-group col-4 offset-4">
                                                            ...
                                                            <input id="num_dec" name="num_dec" type="text" class="form-control text-center" value="" placeholder="XX/XXXX/XXXX" maxlength="15">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-1">
                                                        <div class="col-4 ">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="nbs" name="nbs" type="text" class="form-control text-center" value="" placeholder="">
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-4 ">
                                                            <div class="form-group">
                                                                ...
                                                                <input  id="date_deb" name="date_deb" type="date" class="form-control text-center" value="" placeholder="" onchange="handler(event);">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-1">
                                                ...
                                                <div class="row mt-5">
                                                    <div class="col-4">
                                                        <table class="table text-center">
                                                            <tr><td><label class="text-danger"  for="jr1">1 . </label><input style="width: 80%;" class="text-center" name="jr1"  id="jr1"  type="text" value=""></td></tr>
                                            ...
                                            <div class="modal-body mx-3">
                                                ...
                                                <div class="container-fluid">
                                                    <div class="row mb-1">
                                                        <div class="form-group col-4 offset-4">
                                                            <div style="text-align: center;"><label for="num_dec" class="control-label mb-1">Numèro Decision</label></div>
                                                            <input id="num_dec" name="num_dec" type="text" class="form-control text-center" value="'.$d["n_decision"].'" placeholder="XX/XXXX/XXXX" maxlength="15">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-1">
                                                        <div class="col-4 ">
                                                            <div class="form-group">
                                                                <div style="text-align: center;"><label for="nbs" class="control-label mb-1">Nb seance</label></div>
                                                                <input id="nbs" name="nbs" type="text" class="form-control text-center" value="'.$d["nbr_s"].'" placeholder="">
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                            <div class="form-group">
                                                                <div style="text-align: center;"><label for="nb_p_s" class="control-label mb-1">nb seance/sem</label></div>
                                                                <select id="nb_p_s" name="nb_p_s" class="form-control text-center">
                                                        ...
                                                        <div class="col-4 ">
                                                            <div class="form-group">
                                                                <div style="text-align: center;"><label for="date_deb" class="control-label mb-1">date debut</label></div>
                                                                <input  id="date_deb" name="date_deb" type="date" class="form-control text-center" value="'.$d["dat_deb"].'" placeholder="" onchange="handler(event);">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-1">
                                                ...
                                                <div class="row mt-5">
                                                    <div class="col-4">
                                                        <table class="table text-center">
                                                            <tr><td><label class="text-danger"  for="jr1">1 . </label><input style="width: 80%;" class="text-center" name="jr1"  id="jr1"  type="text" value="';if($cons=$f->getCon($d["n_decision"],1)) { foreach ($cons as $c) { echo $c["date_jour"];}} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr4">4 . </label><input style="width: 80%;" class="text-center" name="jr4"  id="jr4"  type="text" value="'; $cons=$f->getCon($d["n_decision"],4); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr7">7 . </label><input style="width: 80%;" class="text-center" name="jr7"  id="jr7"  type="text" value="'; $cons=$f->getCon($d["n_decision"],7); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger" for="jr10">10 . </label><input style="width: 80%;" class="text-center" name="jr10" id="jr10" type="text" value="'; $cons=$f->getCon($d["n_decision"],10); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger" for="jr13">13 . </label><input style="width: 80%;" class="text-center" name="jr13" id="jr13" type="text" value="'; $cons=$f->getCon($d["n_decision"],13); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger" for="jr16">16 . </label><input style="width: 80%;" class="text-center" name="jr16" id="jr16" type="text" value="'; $cons=$f->getCon($d["n_decision"],16); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger" for="jr19">19 . </label><input style="width: 80%;" class="text-center" name="jr19" id="jr19" type="text" value="'; $cons=$f->getCon($d["n_decision"],19); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger" for="jr22">22 . </label><input style="width: 80%;" class="text-center" name="jr22" id="jr22" type="text" value="'; $cons=$f->getCon($d["n_decision"],22); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger" for="jr25">25 . </label><input style="width: 80%;" class="text-center" name="jr25" id="jr25" type="text" value="'; $cons=$f->getCon($d["n_decision"],25); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger" for="jr28">28 . </label><input style="width: 80%;" class="text-center" name="jr28" id="jr28" type="text" value="'; $cons=$f->getCon($d["n_decision"],28); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger" for="jr31">31 . </label><input style="width: 80%;" class="text-center" name="jr31" id="jr31" type="text" value="'; $cons=$f->getCon($d["n_decision"],31); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger" for="jr34">34 . </label><input style="width: 80%;" class="text-center" name="jr34" id="jr34" type="text" value="'; $cons=$f->getCon($d["n_decision"],34); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>

                                                        </table>
                                                    </div>
                                                    <div class="col-4">
                                                        <table class="table text-center">
                                                            <tr><td><label class="text-danger"  for="jr2">2 . </label><input style="width: 80%;" class="text-center" name="jr2"  id="jr2"  type="text" value="'; $cons=$f->getCon($d["n_decision"],2); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr5">5 . </label><input style="width: 80%;" class="text-center" name="jr5"  id="jr5"  type="text" value="'; $cons=$f->getCon($d["n_decision"],5); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr8">8 . </label><input style="width: 80%;" class="text-center" name="jr8"  id="jr8"  type="text" value="'; $cons=$f->getCon($d["n_decision"],8); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr11">11 . </label><input style="width: 80%;" class="text-center" name="jr11" id="jr11" type="text" value="'; $cons=$f->getCon($d["n_decision"],11); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr14">14 . </label><input style="width: 80%;" class="text-center" name="jr14" id="jr14" type="text" value="'; $cons=$f->getCon($d["n_decision"],14); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr17">17 . </label><input style="width: 80%;" class="text-center" name="jr17" id="jr17" type="text" value="'; $cons=$f->getCon($d["n_decision"],17); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr20">20 . </label><input style="width: 80%;" class="text-center" name="jr20" id="jr20" type="text" value="'; $cons=$f->getCon($d["n_decision"],20); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr23">23 . </label><input style="width: 80%;" class="text-center" name="jr23" id="jr23" type="text" value="'; $cons=$f->getCon($d["n_decision"],23); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr26">26 . </label><input style="width: 80%;" class="text-center" name="jr26" id="jr26" type="text" value="'; $cons=$f->getCon($d["n_decision"],26); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr29">29 . </label><input style="width: 80%;" class="text-center" name="jr29" id="jr29" type="text" value="'; $cons=$f->getCon($d["n_decision"],29); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr32">32 . </label><input style="width: 80%;" class="text-center" name="jr32" id="jr32" type="text" value="'; $cons=$f->getCon($d["n_decision"],32); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr35">35 . </label><input style="width: 80%;" class="text-center" name="jr35" id="jr35" type="text" value="'; $cons=$f->getCon($d["n_decision"],35); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                        </table>
                                                    </div>
                                                    <div class="col-4">
                                                        <table class="table text-center">
                                                            <tr><td><label class="text-danger"  for="jr3">3 .</label><input style="width: 80%;" class="text-center" name="jr3"  id="jr3"  type="text" value="'; $cons=$f->getCon($d["n_decision"],3); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr6">6 .</label><input style="width: 80%;" class="text-center" name="jr6"  id="jr6"  type="text" value="'; $cons=$f->getCon($d["n_decision"],6); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr9">9 .</label><input style="width: 80%;" class="text-center" name="jr9"  id="jr9"  type="text" value="'; $cons=$f->getCon($d["n_decision"],9); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr12">12 .</label><input style="width: 80%;" class="text-center" name="jr12" id="jr12" type="text" value="'; $cons=$f->getCon($d["n_decision"],12); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr15">15 .</label><input style="width: 80%;" class="text-center" name="jr15" id="jr15" type="text" value="'; $cons=$f->getCon($d["n_decision"],15); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr18">18 .</label><input style="width: 80%;" class="text-center" name="jr18" id="jr18" type="text" value="'; $cons=$f->getCon($d["n_decision"],18); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr21">21 .</label><input style="width: 80%;" class="text-center" name="jr21" id="jr21" type="text" value="'; $cons=$f->getCon($d["n_decision"],21); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr24">24 .</label><input style="width: 80%;" class="text-center" name="jr24" id="jr24" type="text" value="'; $cons=$f->getCon($d["n_decision"],24); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr27">27 .</label><input style="width: 80%;" class="text-center" name="jr27" id="jr27" type="text" value="'; $cons=$f->getCon($d["n_decision"],27); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr30">30 .</label><input style="width: 80%;" class="text-center" name="jr30" id="jr30" type="text" value="'; $cons=$f->getCon($d["n_decision"],30); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr33">33 .</label><input style="width: 80%;" class="text-center" name="jr33" id="jr33" type="text" value="'; $cons=$f->getCon($d["n_decision"],33); foreach ($cons as $c) { echo $c["date_jour"];} echo'"></td></tr>
                                                            <tr><td><label class="text-danger"  for="jr36">36 .</label><input style="width: 80%;" class="text-center" name="jr36" id="jr36" type="text" value="'; if($cons=$f->getCon($d["n_decision"],36)) {foreach ($cons as $c) { echo $c["date_jour"];}} echo'"></td></tr>
                                                        </table>
                                                    </div>
                                                </div>
                                            </div>
